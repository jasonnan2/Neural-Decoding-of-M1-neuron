function [shift,T]=data_shift(train)
N=91;K=8;bin=20;
        ...
        for j=1:Num_trials(i)
            ...
            for b=0:bin-1
                for t=1:T{r,i}(j)
                    ...
                    shift(r,i).data(j,b+1).spikes(:,t)=sum(range,2);
                    shift(r,i).data(j,b+1).arm(1,t)=train_arm(1,up);
                    shift(r,i).data(j,b+1).arm(2,t)=train_arm(2,up);
                    if t==1
                        shift(r,i).data(j,b+1).arm(3,t)=(train_arm(1,up)-train_arm(1,low))/20;
                        shift(r,i).data(j,b+1).arm(4,t)=(train_arm(2,up)-train_arm(2,low))/20;
                    else
